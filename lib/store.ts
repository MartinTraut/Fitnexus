...
export function initializeStore(): void {
  ...
  const seedWorkout: WorkoutPlan = {
    ...
    week_number: 1,
    exercises: [
      { id: 'ex_1', name: 'Bankdrücken', sets: 4, reps: '8-10', weight: '80kg', rest_seconds: 90, notes: 'Controlled eccentric', order: 1, day: 1, superset_group: null },
      { id: 'ex_2', name: 'Schrägbankdrücken (KH)', sets: 3, reps: '10-12', weight: '30kg', rest_seconds: 75, notes: null, order: 2, day: 1, superset_group: null },
      { id: 'ex_3', name: 'Butterfly', sets: 3, reps: '12-15', weight: '20kg', rest_seconds: 60, notes: 'Peak contraction halten', order: 3, day: 1, superset_group: null },
      { id: 'ex_4', name: 'Trizeps Pushdowns', sets: 3, reps: '12-15', weight: '25kg', rest_seconds: 60, notes: null, order: 4, day: 1, superset_group: null },
      { id: 'ex_5', name: 'Kniebeugen', sets: 4, reps: '6-8', weight: '100kg', rest_seconds: 120, notes: 'ATG', order: 1, day: 2, superset_group: null },
      { id: 'ex_6', name: 'Beinpresse', sets: 3, reps: '10-12', weight: '180kg', rest_seconds: 90, notes: null, order: 2, day: 2, superset_group: null },
      { id: 'ex_7', name: 'Beinstrecker', sets: 3, reps: '12-15', weight: '50kg', rest_seconds: 60, notes: null, order: 3, day: 2, superset_group: null },
      { id: 'ex_8', name: 'Wadenheben', sets: 4, reps: '15-20', weight: '40kg', rest_seconds: 45, notes: null, order: 4, day: 2, superset_group: null },
      { id: 'ex_9', name: 'Klimmzüge', sets: 4, reps: '8-10', weight: 'Bodyweight', rest_seconds: 90, notes: 'Schulterbreit', order: 1, day: 3, superset_group: null },
      { id: 'ex_10', name: 'Langhantelrudern', sets: 4, reps: '8-10', weight: '70kg', rest_seconds: 90, notes: 'Obergriff', order: 2, day: 3, superset_group: null },
      { id: 'ex_11', name: 'Face Pulls', sets: 3, reps: '15-20', weight: '15kg', rest_seconds: 60, notes: null, order: 3, day: 3, superset_group: null },
      { id: 'ex_12', name: 'Bizeps Curls', sets: 3, reps: '10-12', weight: '15kg', rest_seconds: 60, notes: null, order: 4, day: 3, superset_group: null },
    ],
